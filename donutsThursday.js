//$( document ).ready(function() {
  ...
  function Location(shopName, openHours, peopleNumLow, peopleNumHigh, percentEnter, avgDonutsOrdered) {
    ...
    this.hourlyReport = function() {
        document.write("The " + this.shopName + " Top Pot location needs " + (this.hourlyDonutProjection()) + " donuts for hour " + i + " of the day.");
    }
  ...
  for(j=0; j < shopArray.length; j++) {
    ...
    stringOutput.innerHTML = document.write("Daily projected totals for the " + shopArray[j].shopName + " location: " +dailyTotal + " donuts");
